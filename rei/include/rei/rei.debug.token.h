#ifndef REI_DEBUG_TOKEN_H
#define REI_DEBUG_TOKEN_H

#include "../../src/lexer/rei_token.h"
#include <string.h>
#include <inttypes.h>
...
static const char* reiTokenTypeNames_g[REI_TOKEN_TYPE_EOF + 1] =
{
    "NIL", "TRUE", "FALSE",
    "INT", "FLOAT", "STRING",
    "IDENTIFIER",
...
static const char* reiTokenTypeToCstr(ReiTokenType type)
{
    return reiTokenTypeNames_g[type];
}
static char* reiTokenToCstr(const ReiToken* me, char* buff, size_t len)
{
    switch (me->type)
