...
#pragma endregion
#pragma region Sugar
#define C_TEMPLATE_STRING_FOREACH(ELEM_PTR_NAME, CONTAINER) C_TEMPLATE_VECTOR_FOREACH(char, CONTAINER, ELEM_PTR_NAME)
#define C_TEMPLATE_STRING_RFOREACH(ELEM_PTR_NAME, CONTAINER) C_TEMPLATE_VECTOR_RFOREACH(char, CONTAINER, ELEM_PTR_NAME)
#pragma endregion
