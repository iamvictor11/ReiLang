...
#pragma endregion
#pragma region Sugar
#define C_TEMPLATE_DLIST_FOREACH(TYPE, ELEM_PTR_NAME, NODE_NAME, CONTAINER_PTR) \
	for (TYPE* ELEM_PTR_NAME = (CONTAINER_PTR)->head; ELEM_PTR_NAME != NULL; ELEM_PTR_NAME = (ELEM_PTR_NAME)->NODE_NAME.next)
#define C_TEMPLATE_DLIST_RFOREACH(TYPE, ELEM_PTR_NAME, NODE_NAME, CONTAINER_PTR) \
	for (TYPE* ELEM_PTR_NAME = (CONTAINER_PTR)->tail; ELEM_PTR_NAME != NULL; ELEM_PTR_NAME = (ELEM_PTR_NAME)->NODE_NAME.prev)
#pragma endregion
